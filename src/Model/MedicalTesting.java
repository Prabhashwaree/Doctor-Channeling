...
public class MedicalTesting {
    ...
    public MedicalTesting() {
    }

    public MedicalTesting(String testingId, String date, String time, String type, Double testingPrize, String paymentId, String presNo) {
