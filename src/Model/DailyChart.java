...
public class DailyChart {
    ...
    public DailyChart(Double hour2, Double hour4, Double hour6, Double hour8, Double hour10, Double hour12, Double hour14, Double hour16, Double hour18, Double hour20, Double hour22, Double hour24) {
        this.setHour2(hour2);
        this.setHour4(hour4);
        this.setHour6(hour6);
        this.setHour8(hour8);
        this.setHour10(hour10);
        this.setHour12(hour12);
        this.setHour14(hour14);
        this.setHour16(hour16);
        this.setHour18(hour18);
        this.setHour20(hour20);
        this.setHour22(hour22);
